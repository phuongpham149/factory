...
<!-- Start Content-->
		<div id="content" class="col-xs-12 col-sm-10">
			...
			<div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Tình trạng máy trong chuyền</h1>
            </div>
            <!-- /.col-lg-12  -->
        	</div>
			 <div class="row">
        		...
        		<table class="table table-striped table-bordered table-hover" id="dataTables-dsSinhVien">
        			...
        			<tbody id="tbl-body">
        				<tr>
        					...
        					<td>R10001</td>
        					<td>
        					<button type="button" id="btn-xoa" class="btn btn-danger btn-delete" data-toggle="modal" data-target="#myModal"><i class="fa fa-edit"></i></button>
        					</td>
        				</tr>
        			</tbody>
        		</table>
				...
				<div class="modal-content">
					<form id="form-xoa" action="<%=request.getContextPath()%>/Admin_CategoryDeleteAction" method="post">
						...
						<div class="modal-body">
							<p>Bạn muốn xác nhận máy hỏng?</p>
						</div>
